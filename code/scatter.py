...
def Correlations(df):
    ...
    print('thinkstats2 SpearmanCorr', thinkstats2.SpearmanCorr(
        df.htm3, df.wtkg2))
    print('thinkstats2 SpearmanCorr log wtkg3', thinkstats2.SpearmanCorr(
        df.htm3, np.log(df.wtkg2)))
    print()

    print('thinkstats2 Corr log wtkg3', thinkstats2.Corr(
        df.htm3, np.log(df.wtkg2)))
    print()
